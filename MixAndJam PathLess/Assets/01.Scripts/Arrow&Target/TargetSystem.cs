...
public class TargetSystem : MonoBehaviour
{
    ...
    [SerializeField] private float screenDistanceWeight = 1;
    [SerializeField] private float positionDistanceWeight = 8;
    ...
    [SerializeField] private CloneTargetSlider targetClonePrefab;
    ...
    [SerializeField] private float deltaSpeed = 100;
    ...
    void CloneInterface(float chargeValue)
    {
        ...
        CloneTargetSlider clonedTarget = Instantiate(targetClonePrefab, rectImage.position, rectImage.rotation, rectImage.parent);
